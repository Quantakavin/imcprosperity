"""
=============================================================================
PROSPERITY 4 — ROUND 1 TRADER v11 (final submission)
=============================================================================
Products:
...
RESULTS HISTORY:
    v3:  6,294  v6:  6,876  v8:  8,400  v9:  8,555  v10: 8,679

V11 CHANGES (safe, non-overfitting improvements):

    1. OSMIUM: SEPARATE LIMITS FOR TAKES vs PASSIVE
       Takes use FULL exchange limit (±80). Passive quotes use soft limit (±50).
       Rationale: a take at 9997 is 3pts of guaranteed profit. We should grab it
       even at position +50. The edge is known and justifies the position risk.
       Passive fills have unknown edge (might be adverse selection) → keep capped.
       Missed ~225 PnL in v10 from soft_limit blocking profitable takes.

    2. OSMIUM: HANDLE 1-SIDED BOOK
       84 ticks (8.4%) had only bids or only asks. v10 sent zero orders.
       Now: still take mispriced orders on visible side, still post passive quote.
       Missed ~76 PnL in v10.

    3. OSMIUM: LOWER PANIC THRESHOLD 40 → 30
       Unwind faster = more capacity for profitable takes. At |pos|=30, a 3pt
       adverse move = 90 loss (manageable). Trading at fair (0 profit) to get
       back to 30 frees up room for the next 4+ pt take that comes along.

    PEPPER: Unchanged from v10. Buy fast, hold forever. 96% of theoretical max.

EXPECTED: PEPPER ~7,300 + OSMIUM ~1,700 = ~9,000
=============================================================================
"""
