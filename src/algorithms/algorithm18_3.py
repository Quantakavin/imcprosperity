"""
=============================================================================
PROSPERITY 4 — ROUND 1 TRADER v18.3
=============================================================================
ABLATION GOAL:
    Test only CHANGE 3 from algorithm18:
        OSMIUM weak-edge inventory filter

WHAT IS ACTIVE:
    - Friend baseline Pepper logic
    - Friend baseline Osmium logic
    - NEW: suppress the weakest OSMIUM fades when inventory is already stretched
...
Why this ablation exists:
    This file isolates whether a tiny bit of discipline on the weakest OSMIUM
    edges helps, or whether that filter just cuts useful turnover.
=============================================================================
"""
...
class Trader:
    ...
    def trade_osmium(self, order_depth: OrderDepth, position: int) -> list[Order]:
        ...
        # CHANGE 3 ONLY:
        # keep baseline structure, but trim the weakest fades when inventory
        # is already stretched the wrong way.
        ...
        # Keep friend baseline quote prices and full-size passive room unchanged.
