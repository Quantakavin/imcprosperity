"""
=============================================================================
PROSPERITY 4 — ROUND 1 TRADER v21.1
=============================================================================
Local parameter search around the best v18/v21 structure.

CHANGE FROM v21:
    OSMIUM_WEAK_EDGE_GUARD: 45 -> 40

Idea:
    Allow the weakest OSMIUM fades (9999 buys / 10001 sells) a little more
    often before inventory suppression kicks in.
=============================================================================
"""
