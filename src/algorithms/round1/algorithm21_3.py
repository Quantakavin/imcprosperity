"""
=============================================================================
PROSPERITY 4 — ROUND 1 TRADER v21.3
=============================================================================
Local parameter search around the best v18/v21 structure.

CHANGE FROM v21:
    OSMIUM_PANIC_THRESHOLD: 30 -> 25

Idea:
    Allow fair-price inventory relief a bit earlier, which may free room for
    later profitable OSMIUM trades.
=============================================================================
"""
