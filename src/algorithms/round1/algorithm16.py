"""
=============================================================================
PROSPERITY 4 — ROUND 1 TRADER v16
=============================================================================
Products:
...
V16:
    Start from v14 and make the weak-edge filter asymmetric.

    OSMIUM:
      - keep fair fixed at 10000
      - keep strong takes unchanged
      - keep passive quoting unchanged
      - continue filtering the weakest buy-side fade:
          * buy at 9999 only if panic-short
      - restore weak sell-side fades:
          * sell at 10001 like v11 again

    Rationale:
      v14's slight improvement suggests the weakest buy-side fades were the
      noisier edge. Weak sell-side fades may still be worth keeping. This tests
      that asymmetry with one tiny change.
=============================================================================
"""
    ...
    def run(self, state: TradingState):
        ...
        for product in state.order_depths:
            ...
            # =================================================================
                ...
                # Weakest buy fade at 9999 is only allowed in panic unwind.
                # Weak sell fade at 10001 is restored in v16.
