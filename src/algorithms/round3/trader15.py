"""
================================================================================
IMC PROSPERITY 4 — ROUND 3 — v15 (staged entry + core Hydrogel short)
================================================================================
...
THE STRATEGY HERE:
  ...
  1. HYDROGEL_PACK:
     Keep trader14's staged short entry, but preserve a core Hydrogel short
     once the market is weak:
...
class Trader:
    ...
    HG_RICH_SOFT_BAND = 2
    HG_RICH_MID_BAND = 7
    HG_SHORT_CAP_SOFT = -40
    HG_SHORT_CAP_MID = -100
