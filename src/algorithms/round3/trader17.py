"""
================================================================================
IMC PROSPERITY 4 — ROUND 3 — v17 (Hydrogel warm-up cap)
================================================================================
...
THE STRATEGY HERE:
  ...
  1. HYDROGEL_PACK:
     Keep trader16's inventory logic, but add an explicit time-based warm-up
     cap for Hydrogel so the first few thousand ticks cannot immediately load
     the full short:
