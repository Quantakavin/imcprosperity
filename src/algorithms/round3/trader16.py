"""
================================================================================
IMC PROSPERITY 4 — ROUND 3 — v16 (slower Hydrogel opening ramp)
================================================================================
...
THE STRATEGY HERE:
  ...
  1. HYDROGEL_PACK:
     Keep trader15's core-short logic, but slow the Hydrogel short build much
     more aggressively near the open and whenever price is only slightly rich:
