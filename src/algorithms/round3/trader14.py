"""
================================================================================
IMC PROSPERITY 4 — ROUND 3 — v14 (staged Hydrogel entry)
================================================================================
...
WHY THIS VERSION EXISTS:
  ...
  trader13 fixed that reversal problem, but it still reached max short almost
...
THE STRATEGY HERE:
  ...
  1. HYDROGEL_PACK:
     Keep trader13's asymmetric buy-side protection, and also make the SELL
     side above fair build inventory in stages:
       ...
       - if Hydrogel is only a little above fair, do not allow an immediate
         rush to -200; scale into the short as richness increases
...
class Trader:
    ...
    HG_RICH_SOFT_BAND = 4
    HG_RICH_MID_BAND = 9
    HG_SHORT_CAP_SOFT = -60
    HG_SHORT_CAP_MID = -120
