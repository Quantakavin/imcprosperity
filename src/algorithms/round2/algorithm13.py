"""
=============================================================================
PROSPERITY 4 — ROUND 2 TRADER 13
=============================================================================
One last OSMIUM-only tuning pass before moving on to MAF ablations.

Design:
    - PEPPER remains exactly on the algorithm4 baseline
    - OSMIUM keeps the spread-regime idea from algorithm11
    - this version goes slightly stricter than algorithm11

Hypothesis:
    algorithm11 beat algorithm12, which suggests OSMIUM benefits from stronger
    selectivity. This file tests whether filtering a bit harder on weaker
    spreads improves realized quality further.
=============================================================================
"""
