"""
=============================================================================
PROSPERITY 4 — ROUND 2 TRADER 4
=============================================================================
Hybrid follow-up to algorithm3.

Design:
    - Keep the improved OSMIUM logic from algorithm3:
        * slow adaptive fair
        * stronger inventory-aware quote skew
    - Relax PEPPER slightly versus algorithm3 so the bot can cycle inventory
      around the long core more often instead of becoming too sticky.

Intent:
    Recover some of the PEPPER PnL that algorithm3 gave up, without reverting
    OSMIUM to the weaker static-fair behavior from earlier versions.
=============================================================================
"""
