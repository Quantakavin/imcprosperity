"""
=============================================================================
PROSPERITY 4 — ROUND 2 TRADER 2
=============================================================================
Round 2 variant built from round2/algorithm1, with a Market Access Fee bid.

Rationale:
    - The data still favors the same core split:
        * ASH_COATED_OSMIUM -> spread capture / market making
        * INTARIAN_PEPPER_ROOT -> directional inventory-managed trading
    - The new strategic lever in Round 2 is the Market Access Fee.
    - Extra access looks most valuable if it increases OSMIUM interaction.

Bid policy:
    This version uses a moderate fixed bid of 15 XIRECs. The goal is to stay
    competitive for top-half access without paying an obviously extreme price.
=============================================================================
"""
