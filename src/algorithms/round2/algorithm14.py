"""
=============================================================================
PROSPERITY 4 — ROUND 2 TRADER 14
=============================================================================
Explicit hybrid:
    - PEPPER logic from algorithm4 baseline
    - OSMIUM spread-regime sizing from algorithm13

Why this exists:
    The recent ablations suggest:
      - PEPPER redesigns mostly hurt
      - stricter OSMIUM spread selection helped OSMIUM PnL

This file makes that combination explicit so it can be tested directly before
moving on to MAF bid ablations.
=============================================================================
"""
